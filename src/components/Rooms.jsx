  ...
  return (
    <div className='max-w-[1400px] h-[500px] bg-blue-100 mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-4'>
      <div className='lg:top-20 relative lg:col-span-1 col-span-2'>
        <h3 className='text-2xl font-bold'>Cultivating Prosperity, Nourishing Communitiess</h3>
        <p className='pt-4'>
Join us in sowing the seeds of a brighter future for farmers and communities alike. Together, we're cultivating not just crops, but opportunities for sustainable growth and shared prosperity. Let's harvest a future where every farmer thrives and every community flourishes.
        </p>
      </div>
